...
# Formato: (categoria_interna, subcategoria_visible, path). Los paths salen de
# `python -m app.descubrir_taxonomia lider`; estan en el JSON del home escapados
# como \\/browse\\/..., no como href (por eso no aparecian buscando enlaces).
# Excluidos: automovil, ferreteria, hogar, la-boti (farmacia), libreria,
# parrillas-y-jardin, tecno-y-electro, vestuario, deporte, salud-y-estilos-de-vida,
# y marcas-propias / marcas-americanas (duplican productos de otros rubros).
CATEGORIAS_BROWSE = [
    # -> Bebe
    ("Bebe", "Actividades Bebe", "/browse/mundo-bebe-y-jugueteria/actividades-bebe/11780484_85214299"),
    ...
    ("Bebe", "Ropa De Bebe", "/browse/mundo-bebe-y-jugueteria/ropa-de-bebe/11780484_75259820"),
    # -> Bebidas
    ...
    ("Bebidas", "Snacks Y Picoteo", "/browse/bebidas-y-snacks/snacks-y-picoteo/13901022_66742898"),
    # -> Carnes y Pescados
    ...
    ("Higiene Personal", "Maquillaje", "/browse/belleza/maquillaje/70159643_23689372"),
    ("Higiene Personal", "Perfumes Y Fragancias", "/browse/belleza/perfumes-y-fragancias/70159643_96116047"),
    ("Higiene Personal", "Rutina Corporal", "/browse/belleza/rutina-corporal/70159643_38045396"),
    ("Higiene Personal", "Rutina Facial", "/browse/belleza/rutina-facial/70159643_52759372"),
    ...
    ("Higiene Personal", "Salud Y Suplementos", "/browse/higiene-y-cuidado-personal/salud-y-suplementos/72387472_67725176"),
    ("Higiene Personal", "Belleza", "/browse/perfumeria-y-salud/belleza/79913105_14554833"),
    ("Higiene Personal", "Cuidado Adulto Mayor (Perfumeria)", "/browse/perfumeria-y-salud/cuidado-adulto-mayor/79913105_36806076"),
    ("Higiene Personal", "Cuidado Bucal (Perfumeria)", "/browse/perfumeria-y-salud/cuidado-bucal/79913105_79132028"),
    ...
    ("Lacteos, Huevos y Congelados", "Dulces_Mermeladas_Y_Manjar", "/browse/frescos-y-lacteos/dulces_mermeladas_y_manjar/45669105_21333127"),
    ("Lacteos, Huevos y Congelados", "Fiambres Y Embutidos", "/browse/frescos-y-lacteos/fiambres-y-embutidos/45669105_22196003"),
    ...
    ("Limpieza", "Mascotas En Casa", "/browse/limpieza-y-aseo/mascotas-en-casa/43390617_43573441"),
